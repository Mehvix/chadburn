document.addEventListener("DOMContentLoaded", function () {
    ...
    if (window.onresize = function (e) {
        ...
        [].forEach.call(n, function (o) {
            o.addEventListener("click", function (e) {
                e.preventDefault();
                var t = document.querySelector(".landing__section"), n = o.getAttribute("data-speed");
                t && function (e, t) {
                    var n, o = window.pageYOffset, r = e.offsetTop - 40, i = (r - o) / (t / 16);
                    0 <= i && (n = function () {
    ...
    return function i(s, a, c) {
        ...
        1: [function (e, t, n) {
            ...
            t.exports = function (t) {
                var n;
                t.lines = [n = {main: 0, cross: 0, children: []}], t.children.forEach(function (e) {
            ...
            o.exports = function (e) {
                var t = o.exports.walk(e), n = o.exports.flexbox(t);
    ...
    var e = function (e, t) {
        ...
        }, m = g.createElement("style"), h = g.documentElement, p = function (e, t) {
            var n;
        ...
        return p.prototype = {
            destroy: function () {
                ...
                if (i.customToggle) {
                    ...
                    if (g.getElementById(e)) n = g.getElementById(e); else {
                ...
                if (i.closeOnNavClick) {
                    var n = r.getElementsByTagName("a"), o = this;
                    !function (e, t, n) {
                ...
                if (i.animate) {
                    var e = r.style, t = "max-height " + i.transition + "ms";
